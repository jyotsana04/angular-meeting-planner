...
export class LoginComponent implements OnInit {
  ...
  constructor(private authService: AuthService, private userHttpService: UserHttpService, public toastr: ToastrService, public router: Router, public SocketService: SocketService) { }
